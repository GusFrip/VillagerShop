...
public class ShopBadgeCoverLayer extends RenderLayer<Villager, VillagerModel<Villager>> {
    private static final ResourceLocation TEX =
            new ResourceLocation(ShopMod.MOD_ID, "textures/entity/villager/profession/shopkeeper.png");
    ...
    public void render(PoseStack poseStack, MultiBufferSource buffer, int packedLight, Villager villager,
        ...
        renderColoredCutoutModel(getParentModel(), TEX, poseStack, buffer, packedLight, villager, 1.0F, 1.0F, 1.0F);
    }
}
