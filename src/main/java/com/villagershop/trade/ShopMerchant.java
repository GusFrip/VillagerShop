...
public class ShopMerchant implements Merchant {
    ...
    /**
     * 1.21 : MerchantOffer exige des ItemCost. On matche item + composants exacts
     * (parite avec l'ancien isSameItemSameTags). Cout vide -> AIR (stack vide),
     * gere comme offre gratuite par ShopMerchantMenu.
     */
    private static ItemCost toCost(ItemStack stack) {
        if (stack.isEmpty()) return new ItemCost(Items.AIR, 1);
