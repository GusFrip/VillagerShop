...
public class ShopStockMenu extends AbstractContainerMenu implements ScrollableStorageMenu {
    ...
    /** Constructeur CLIENT (Fabric : la donnée d'ouverture est le BlockPos). */
    public ShopStockMenu(int id, Inventory inv, BlockPos pos) {
        this(id, inv, null, pos,
    ...
    private ShopStockMenu(int id, Inventory inv, @Nullable ShopBlockEntity be, BlockPos pos,
                          ItemStackHandler storage, ItemStackHandler chestHandler) {
        super(ModMenus.SHOP_STOCK, id);
        this.be = be;
        this.pos = pos;
