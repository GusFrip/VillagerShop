...
public class ShopTradeMenu extends AbstractContainerMenu {
    ...
    /** Constructeur CLIENT (Fabric : chemin hérité, non ouvert en pratique). */
    public ShopTradeMenu(int id, Inventory inv, BlockPos pos) {
        super(ModMenus.SHOP_TRADE, id);
        this.shopPos = pos;
        for (int i = 0; i < OFFERS; i++) offers[i] = new ShopOffer();
